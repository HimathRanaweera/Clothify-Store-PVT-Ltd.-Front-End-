  ...
  return (
    ...
    <div>
      <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img class="bd-placeholder-img" width="100%" height="100%" src=".\src\images\png\02.png" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false" />
            {/* <rect width="100%" height="100%" fill="var(--bs-secondary-color)"/></svg> */}
            <div class="container">
      ...
      <div class="container marketin">
        ...
        <div class="row">
          <div class="col-lg-4">
            <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="" role="img" aria-label="Placeholder" preserveAspectRatio="xMidYMid slice" focusable="false" />
            {/* <title>Placeholder</title><rect width="100%" height="100%" fill="var(--bs-secondary-color)"/></svg> */}
